...
app_state = () => ({
  ...
  heuristic: "manhattan", weight: 1, diagonal: false,
...
app_search = {
  ...
  function stepOnce(s) {
    ...
    if (s.diagonal) dirs.push(...[[1,1],[1,-1],[-1,1],[-1,-1]]);
...
app = {
  ...
  const diagCheck = Object.assign(document.createElement("input"), {type:"checkbox"});
  ...
  selMode.onchange      = e => { s.editMode  = e.target.value; };
  ...
  diagCheck.onchange = e => { s.diagonal = e.target.checked; stopAnim(); resetSearch(s); redraw(); };
