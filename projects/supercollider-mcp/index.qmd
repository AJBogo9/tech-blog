...
date: "2026-06-14"
description: "An MCP server that gives an LLM a synthesis engine, a feedback loop, and ears."
image: "thumbnail.png"
categories:
  - python
  - MCP
...
[GitHub](https://github.com/AJBogo9/supercollider-mcp){.btn .btn-outline-secondary .btn-sm}
...
The MCP server uses [FastMCP](https://github.com/jlowin/fastmcp). It is a Python library that turns decorated functions into MCP tools. Each tool is a plain python function and the docstring for the function becomes the tool's description that the LLM reads to decide when and how to use the tool.
...
<audio controls style="width:100%; margin: 1rem 0;">
  <source src="choir_demo_v3.mp3" type="audio/mpeg">
</audio>
```
